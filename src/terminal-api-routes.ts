...
export class TerminalApiRoutes {
  ...
  private setupRoutes(): void {
    ...
    this.fastify.get('/api/terminals/:terminalId', async (request: FastifyRequest, reply: FastifyReply) => {
      try {
    ...
    this.fastify.post('/api/terminals/:terminalId/input', async (request: FastifyRequest, reply: FastifyReply) => {
      try {
        const { terminalId } = request.params as { terminalId: string };
    ...
    this.fastify.get('/api/terminals/:terminalId/output', async (request: FastifyRequest, reply: FastifyReply) => {
      try {
        const { terminalId } = request.params as { terminalId: string };
    ...
    this.fastify.get('/api/terminals/:terminalId/stats', async (request: FastifyRequest, reply: FastifyReply) => {
      try {
        const { terminalId } = request.params as { terminalId: string };
    ...
    this.fastify.delete('/api/terminals/:terminalId', async (request: FastifyRequest, reply: FastifyReply) => {
      try {
        const { terminalId } = request.params as { terminalId: string };
        const query = request.query as any;
    ...
    this.fastify.put('/api/terminals/:terminalId/resize', async (request: FastifyRequest, reply: FastifyReply) => {
      try {
        const { terminalId } = request.params as { terminalId: string };
    ...
    this.fastify.get('/stats', async (request: FastifyRequest, reply: FastifyReply) => {
      try {
        const stats = this.terminalManager.getStats();
        return stats;
      } catch (error) {
    ...
    this.fastify.post('/api/settings/reset', async (request: FastifyRequest, reply: FastifyReply) => {
      try {
