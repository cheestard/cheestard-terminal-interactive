 ...
 */
async function main() {
  log('Starting Cheestard Terminal Interactive MCP Server...');

  // 创建 MCP 服务器实例
  const mcpServer = new CheestardTerminalInteractiveServer();
  ...
  log('Cheestard Terminal Interactive MCP Server started successfully');
